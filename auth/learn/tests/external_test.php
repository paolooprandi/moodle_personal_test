...
/**
 * Auth learn external functions tests.
 *
 * @package    auth_learn
 * @category   external
 ...
 * @since       Moodle 3.8
 */
class auth_learn_external_testcase extends externallib_advanced_testcase {
    ...
    public function test_get_signup_settings() {
        ...
        $result = auth_learn_external::get_signup_settings();
        $result = external_api::clean_returnvalue(auth_learn_external::get_signup_settings_returns(), $result);
    ...
    public function test_signup_user() {
        ...
        // Create new user.
        $result = auth_learn_external::signup_user($username, $password, $firstname, $lastname, $email, $city,  $country,
                                                    '', '', $customprofilefields);
        $result = external_api::clean_returnvalue(auth_learn_external::signup_user_returns(), $result);
