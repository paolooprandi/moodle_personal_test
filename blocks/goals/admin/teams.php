...
$PAGE->navbar->add('Teams', new moodle_url('/blocks/goals/admin/teams.php'));

$action = optional_param('action', '', PARAM_ALPHANUMEXT);
$PAGE->set_context(context_system::instance());
$PAGE->set_url(new moodle_url('/blocks/goals/admin/teams.php', ['action' => $action]));
//admin_externalpage_setup('teams');
