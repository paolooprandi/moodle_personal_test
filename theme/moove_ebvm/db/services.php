...
/**
 * Theme moove_ebvm functions and service definitions.
 *
...
$functions = array(
    'theme_moove_ebvm_fontsize' => array(
        'classname' => 'theme_moove_ebvm\api\accessibility',
        'classpath' => 'theme_moove_ebvm/classes/api/accessibility.php',
        'methodname' => 'fontsize',
        'description' => 'Increase or decrease the site font size.',
        'type' => 'write',
        'ajax' => true
    ),
    'theme_moove_ebvm_sitecolor' => array(
        'classname' => 'theme_moove_ebvm\api\accessibility',
    ...
    'theme_moove_ebvm_savethemesettings' => array(
        'classname' => 'theme_moove_ebvm\api\accessibility',
    ...
    'theme_moove_ebvm_getthemesettings' => array(
        'classname' => 'theme_moove_ebvm\api\accessibility',
