...
$string['pluginname'] = 'moove_ebvm';
$string['configtitle'] = 'moove_ebvm';
$string['choosereadme'] = 'moove_ebvm é um tema moderno e altamente customizável. Este tema tem por objetivo ser usado diretamente, ou como um tema pai quando criados novos temas utilizando Bootstrap 4.';
...
$string['privacy:metadata:preference:thememoove_ebvmsettings_fonttype'] = 'Preferências do usuário para tipo de fonte.';
$string['privacy:metadata:preference:thememoove_ebvmsettings_enableaccessibilitytoolbar'] = 'Preferências do usuário para habilitar a barra de acessibilidade.';
...
$string['privacy:thememoove_ebvmsettings_fonttype'] = 'A preferência atual para o tipo de fonte é: {$a}.';
$string['privacy:thememoove_ebvmsettings_enableaccessibilitytoolbar'] = 'A preferência atual para habilitar a barra de acessibilidade é para exibi-lá';
