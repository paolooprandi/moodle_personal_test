    ...
    function(jQuery, Notification, CustomEvents, Modal, ModalRegistry, Ajax) {
        ...
        var ThemeSettingsModal = function(root) {
            ...
            var request = Ajax.call([{
                methodname: 'theme_moove_ebvm_getthemesettings',
                args: {}
            }]);
        ...
        ThemeSettingsModal.TYPE = 'theme_moove_ebvm-themesettings_modal';
        ...
        ThemeSettingsModal.prototype.registerEventListeners = function() {
            ...
            this.getModal().on(CustomEvents.events.activate, SELECTORS.SAVE_BUTTON, function() {
                var request = Ajax.call([{
                    methodname: 'theme_moove_ebvm_savethemesettings',
                    args: {
        ...
        if (!registered) {
            ModalRegistry.register(ThemeSettingsModal.TYPE, ThemeSettingsModal, 'theme_moove_ebvm/themesettings_modal');
            registered = true;
        }
