...
$THEME->scss = function($theme) {
    ...
    return theme_moove_ebvm_get_main_scss_content($parentconfig);
};

// Process extra scss to our final stylesheet.
$THEME->extrascsscallback = 'theme_moove_ebvm_get_extra_scss';

// Process pre scss to our final stylesheet.
$THEME->prescsscallback = 'theme_moove_ebvm_get_pre_scss';
