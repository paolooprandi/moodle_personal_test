...
namespace theme_moove_ebvm\api;
...
class accessibility extends external_api {
    ...
    public static function savethemesettings($formdata) {
        ...
        if ($data['fonttype'] && in_array($data['fonttype'], ['default', 'odafont'])) {
            ...
            set_user_preference('thememoove_ebvmsettings_fonttype', $fonttype);
        }
        ...
        set_user_preference('thememoove_ebvmsettings_enableaccessibilitytoolbar', $enableaccessibilitytoolbar);

        \core\notification::success(get_string('themesettinggsavedsuccessfully', 'theme_moove_ebvm'));
    ...
    public static function getthemesettings() {
        return [
            'fonttype' => get_user_preferences('thememoove_ebvmsettings_fonttype', 'default'),
            'enableaccessibilitytoolbar' => get_user_preferences('thememoove_ebvmsettings_enableaccessibilitytoolbar', false)
        ];
    }
