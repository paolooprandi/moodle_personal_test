...
namespace theme_moove_ebvm\output;
...
class core_renderer extends \theme_boost\output\core_renderer {
    ...
    public function render_lang_menu() {
        ...
        if ($haslangmenu) {
            ...
            if (isset($context)) {
                return $this->render_from_template('theme_moove_ebvm/lang_menu', $context);
            }
        }
    }
    ...
    public function get_pix_image_url_base() {
        ...
        return $CFG->wwwroot . "/theme/moove_ebvm/pix";
    }
    ...
    public function user_menu($user = null, $withlinks = null) {
        ...
        if (!isloggedin()) {
            ...
            return $this->render_from_template('theme_moove_ebvm/frontpage_guest_loginbtn', $context);
        }
    ...
    public function render_help_icon(help_icon $helpicon) {
        ...
        // Check issue https://github.com/willianmano/moodle-theme_moove_ebvm/issues/5.
    ...
    public function search_box($identifier = false) {
        ...
        return html_writer::tag('div',
                                ...
                                array('class' => 'moove_ebvm-search-input nav-link', 'id' => $identifier));
    }
    ...
    public function breadcrumb_header() {
        ...
        if ($this->page->pagelayout == 'mypublic') {
            $header->contextheader = "<h2>". get_string('userprofile', 'theme_moove_ebvm') ."</h2>";
        }

        return $this->render_from_template('theme_moove_ebvm/breadcrumb', $header);
    }
    ...
    public function body_attributes($additionalclasses = array()) {
        $hasaccessibilitybar = get_user_preferences('thememoove_ebvmsettings_enableaccessibilitytoolbar', '');
        ...
        $fonttype = get_user_preferences('thememoove_ebvmsettings_fonttype', '');
        if ($fonttype) {
